package org.example.hellospringdatajpa;
...
import org.example.hellospringdatajpa.repository.ProductRepository;
...
class HelloSpringDataJpaApplicationTests {
    ...
    public void findByNameContainingWithPaging() {
        ...
        assertEquals(6, productList.size(), "Expected 3 products containing 'MacBook'");
